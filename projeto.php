    ...
    <div class="page">
      ...
      <section class="charts">
        <div class="container">
          ...
          <header>
            <h1 class="h3 display">Lista dos Projetos            </h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <form action="projeto.php" method="POST" class="form-inline col-md-12">
                    <div class="form-group">
                      <button type="button" data-toggle="modal" data-target="#myModal" class=" mr-2 btn btn-primary"><span class="fa fa-plus"></span> Novo Projeto </button>
                    </div>
                    <div class="form-group">
                      <button type="button" data-toggle="modal" data-target="#alertamodal" class="mr-2 btn btn-secondary"><span class="fa fa-times"></span> Apagar </button>
                    </div>
